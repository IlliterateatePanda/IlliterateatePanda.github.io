                    ...
                    h3.addEventListener('animationend', function() {
                        ...
                        if (booting === 230) {
                            setTimeout(() => {
                                ...
                                // Check if bootDeleted is 1 and remove display property from 'win' div
                                if (bootDeleted === 1) {
                                    const winDiv = document.querySelector('.win');
                                    if (winDiv) {
                                        winDiv.style.display = ''; // Remove the display property
                                        console.log('Display property of .win div has been removed.');
                                    }
                                }
